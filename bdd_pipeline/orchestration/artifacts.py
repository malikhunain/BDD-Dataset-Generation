...
try:
    from bdd_pipeline.parsing import _problem_dir as _legacy_generated_problem_dir
except ImportError:
    try:
        from bdd_pipeline.parsing import problem_dir as _legacy_generated_problem_dir
    except ImportError:
